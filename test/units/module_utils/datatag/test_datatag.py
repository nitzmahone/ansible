...
class TestDatatagTarget(AutoParamSupport):
    ...
    def post_init(cls) -> None:
        ...
        cls.serializable_types = [value for value in (
            list(AnsibleSerializable._known_type_map.values()) + [AnsibleSerializable]) if cls.is_FIXME_type_applicable(value)]

    @classmethod
    def is_FIXME_type_applicable(cls, type_obj) -> bool:
        return (
