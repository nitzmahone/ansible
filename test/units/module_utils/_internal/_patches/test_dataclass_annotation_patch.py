...
from ansible.module_utils._internal._patches import _dataclass_annotation_patch


def test_classvar_fields() -> None:
    """Verify that typing.ClassVar works with dataclasses after patch has been applied (if required)."""
