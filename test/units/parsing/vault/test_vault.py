...
from ansible.template.jinja_common import VaultExceptionMarker, TruncationMarker, Marker
...
def make_marker(marker_type: type[Marker], *args, **kwargs):
    ...
    with TemplateContext(template_value="blah", templar=Templar(), options=TemplateOptions.DEFAULT):
