...
MODULE_UTILS_BASIC_FILES = frozenset(('ansible/__init__.py',
                                      ...
                                      'ansible/module_utils/_internal/_dataclass_annotation_patch.py',
                                      'ansible/module_utils/_internal/_dataclass_validation.py',
                                      'ansible/module_utils/_internal/_debugging.py',
                                      'ansible/module_utils/_internal/_errors.py',
                                      'ansible/module_utils/_internal/_serialization.py',
                                      'ansible/module_utils/_internal/_sys_intern_patch.py',
                                      ...
                                      'ansible/module_utils/datatag/access.py',
