...
def _tag_ignore_magicmock():
    orig_tag = AnsibleTaggedObject.tag
    return patch.object(AnsibleTaggedObject, 'tag', lambda value, *args, **kwargs: value if isinstance(value, MagicMock) else orig_tag(value, *args, **kwargs))
