...
def test_suppress_extended_error_deprecation() -> None:
    ...
    assert ctx.get_deprecation_warnings()[0]._as_simple_str() == 'The `suppress_extended_error` argument to `AnsibleError` is deprecated. Use `show_content=False` instead.'
