...
class Group:
    ...
    def __deepcopy__(self, memodict):
        raise Exception("deepcopy was not properly implemented on group")  # FIXME: ensure this is unneeded and remove
    ...
    def host_names(self) -> set[str]:
        if self._hosts is None:
            self._hosts = {h.name for h in self.hosts}  # FIXME: if serialization works properly, this can just be set in __init__ like it was before
        return self._hosts
