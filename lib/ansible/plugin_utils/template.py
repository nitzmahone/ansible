...
def generate_ansible_template_vars(path, fullpath=None, dest_path=None):
    ...
    # FIXME: deprecate this in favor of users defining their own variable to replace ansible_managed
    ...
    # FIXME: some config values should be trusted as templates -- config should be able to decide that
