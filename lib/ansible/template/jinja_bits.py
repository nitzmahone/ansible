...
class AnsibleEnvironment(ImmutableSandboxedEnvironment):
    ...
    def __init__(self, *args, ansible_basedir: str | None = None, **kwargs) -> None:
        ...
        self.filters = JinjaPluginIntercept(self.filters, filter_loader)  # type: ignore[assignment]
        self.tests = JinjaPluginIntercept(self.tests, test_loader)  # type: ignore[assignment,arg-type]
...
# finalize is a very hot code path; we're caching these type sets outside the function for optimized perf
