...
class AnsibleSourcePosition(AnsibleDatatagBase):
    ...
    """
    # FIXME: come up with a standard non-magic-string way to denote non-file sources (eg, CLI extra args, envvar, `<string>`)
    src: str
    # FIXME: should these end with no/num/_no/_num?
