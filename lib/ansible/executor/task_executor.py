        ...
        if self._task.loop_with:
            ...
            def invoke_lookup() -> t.Any:
                ...
                return _invoke_lookup(
                    ...
                    te_invoking_action_name=self._task.action,  # FUTURE: this value has not been templated or resolved, it should be (historical problem)...
                )
        ...
        for attempt in range(1, retries + 1):
            ...
            if self._task.register:
                if not isidentifier(self._task.register):
                    # FUTURE: this is duplicated in strategy
