...
from ansible.template.templar import Templar, TemplateMode
...
class TaskExecutor:
                ...
                if len(items) > 0:
                    ...
                    for item in item_results:
                        ...
                        if res['skipped'] and ('skipped' not in item or ('skipped' in item and not item['skipped'])):
                            res['skipped'] = False
                        # TEMPFIX: normalize `failed` to a bool, warn if the action/module used non-bool
    ...
    def _get_loop_items(self):
        ...
        if self._task.loop_with:
            ...
            if isinstance(terms, str):
                terms = templar.template(terms.strip(), mode=TemplateMode.STOP_ON_CONTAINER)
            ...
            def invoke_lookup() -> t.Any:
                ...
                return _invoke_lookup(
                    ...
                    te_invoking_action_name=self._task.action,  # TEMPFIX: this value has not been templated or resolved, it should be (historical problem)...
                )
    ...
    def _execute_internal(self, templar: Templar, variables: dict[str, t.Any]) -> dict[str, t.Any]:
        ...
        for attempt in range(1, retries + 1):
            ...
            # DTFIX-MERGE: nuke this, it hides a lot of error detail
            ...
            if self._task.register:
                if not isidentifier(self._task.register):
                    # TEMPFIX: this is duplicated in strategy
                    raise AnsibleError("Invalid variable name in 'register' specified.", obj=self._task.register)
