...
from ansible.template.jinja_bits import is_possibly_template, is_possibly_all_template
...
class Task(Base, Conditional, Taggable, CollectionSearch, Notifiable, Delegatable):
    ...
    def _post_validate_module_defaults(self, attr: str, value: t.Any, templar: Templar) -> t.Any:
    ...
    def _post_validate_args(self, attr: str, value: t.Any, templar: Templar) -> dict[str, t.Any]:
