...
class AnsibleTagHelper:
    ...
    # FIXME: bikeshed the name and location of this class, since it's public API
    ...
    # FIXME: add docstrings to all non-override methods in this class
    ...
    def get_friendly_type_name(type_or_value: t.Any, /) -> str:
        ...
        # FIXME: provide a way to report the real type for debugging purposes
...
def is_non_scalar_collection_type(value: type) -> t.TypeGuard[type[CollectionWithMro]]:
    ...
    # FIXME: find a better way to exclude _AnsibleTaggedVaultBomb
