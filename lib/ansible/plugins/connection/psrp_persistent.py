...
from ansible._internal._worker._connection_broker import ConnectionBroker, KeyedConnection
...
class _ConnectionInner(KeyedConnection):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._psrp_user = self._psrp_conn_kwargs['username']
        self._psrp_configuration_name = 'Microsoft.PowerShell'  # self._psrp_conn_kwargs['configuration_name']
        self._psrp_auth = self._psrp_conn_kwargs['auth']
