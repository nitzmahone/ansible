...
def get_controller_serialize_map() -> dict[type, t.Callable]:
    ...
    return {
        lazy_containers._AnsibleLazyTemplateDict: _JSONSerializationProfile.discard_tags,
        lazy_containers._AnsibleLazyTemplateList: _JSONSerializationProfile.discard_tags,
...
# DTFIX-MERGE: this is really fragile- disordered/incorrect imports (among other things) can mess it up. Consider a hosting-env-managed context
