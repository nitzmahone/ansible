...
class AnsibleConstructor(SafeConstructor):
    def __init__(
        ...
        self._file_name = None if file_name is None else str(file_name)
    ...
    def _node_position_info(self, node):
        ...
        datasource = self._file_name or node.start_mark.name

        return AnsibleSourcePosition(src=datasource, line=line, col=column)

# FIXME: review and deprecate tags below as appropriate
