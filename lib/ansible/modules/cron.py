...
class CronTab(object):
    ...
    def read(self):
        ...
        if self.cron_file:
            ...
            # TEMPFIX: using safely quoted shell for now, but this really should be two non-shell calls instead.
    ...
    def write(self, backup_file=None):
        ...
        if not self.cron_file:
            # TEMPFIX: quoting shell args for now but really this should be two non-shell calls.
